...
function run_sampler(args::Dict, X::Array{Float64,2}, y::Array{Int64,1}, test_x::Array{Float64,2}, test_y::Array{Int64,1})
    sampler = RandomWalk(X, y, args["stepsize"], args["pca_dim"], args["T"], args["epsilon"], args["delta"])
...
function RandomWalk(X::Array{Float64,2}, y::Array{Int64,1}, stepsize::Float64, pca_dim::Int64, T::Float64,epsilon::Float64, delta::Float64)
    ...
    return RandomWalk(X, y, stepsize, size(X, 2), pca_dim, T, theta_prime,max_psi,sigma,epsilon);
end
